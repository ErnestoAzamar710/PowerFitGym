...
@Component({
  selector: 'app-interfaz-gimnasio-movil',
  templateUrl: './interfaz-gimnasio-movil.page.html',
  styleUrls: ['./interfaz-gimnasio-movil.page.scss'],
})
export class InterfazGimnasioMovilPage implements OnInit {
